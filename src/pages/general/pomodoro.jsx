  ...
  return (
    <>
      ...
      <div className="mt-10 text-center">
        <h2 className="mb-4 text-4xl font-bold">Pomodoro Timer</h2>
        <p className="text-2xl font-semibold">{formatTime()}</p>
        <div className="mt-4 space-x-4">
          <button
            onClick={handleStart}
            disabled={isActive}
            className="rounded bg-blue-500 px-6 py-4 text-xl font-bold text-white hover:bg-blue-700 disabled:opacity-50"
          >
            Start
          </button>
          <button
            ...
            disabled={!isActive}
            className="min-w-32 rounded bg-green-500 px-6 py-4 text-xl font-bold text-white hover:bg-green-700 disabled:opacity-50"
          >
          ...
          <button
            onClick={handleReset}
            disabled={!isActive}
            className="rounded bg-red-500 px-6 py-4 text-xl font-bold text-white hover:bg-red-700 disabled:opacity-50"
          >
            Reset
          </button>
          <button
            onClick={toggleAlarm}
            className={`rounded bg-yellow-500 px-6 py-4 text-xl font-bold text-white hover:bg-yellow-700 ${
